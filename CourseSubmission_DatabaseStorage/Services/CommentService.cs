...
internal class CommentService : GenericService<CommentEntity>
{
    ...
    public async Task CreateInitializedCommentAsync()
    {
        ...
        {
            await _context.AddAsync(new CommentEntity { Id = new Guid("e8622fa6-a076-4171-80f4-e5b05bfb6470"), TextComment = "Now the snow has been shoveled outside your entrance and the case is completed.", Created = DateTime.Parse("2023-03-14 15:00:23"), CaseId = Guid.Parse("f98b98fb-0470-4096-90cd-0b05d8be9fc9"), EmployeeId = 2 });
            await _context.SaveChangesAsync();

            await _context.AddAsync(new CommentEntity { Id = new Guid("fa324713-a369-42c0-8a93-896a1f3fad2a"), TextComment = "The problem has been resolved, and the case is completed.", Created = DateTime.Parse("2023-03-13 10:08:54"), CaseId = Guid.Parse("6bad8146-7c0e-41d1-b646-377cd98d6c0e"), EmployeeId = 3 });
            await _context.SaveChangesAsync();
